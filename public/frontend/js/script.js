...
(function ($) {
	...
	// main-home banner-classic-active js
	var slider = new Swiper(".banner-classic-active2", {
		speed: 1500,
		slidesPerView: 1,
		spaceBetween: 30,
		loop: true,
	...
	var slider = new Swiper(".feature-home2-active", {
		speed: 1500,
		slidesPerView: 4,
		spaceBetween: 30,
		loop: true,
	...
	var slider = new Swiper(".service-home2-active", {
		speed: 1500,
		slidesPerView: 4,
		spaceBetween: 30,
		loop: true,
	...
	var slider = new Swiper(".project-home2-active", {
		speed: 1500,
		slidesPerView: 4,
		spaceBetween: 30,
		loop: true,
	...
	// testi-home2-active
	var slider = new Swiper(".testi-home2-active", {
		speed: 1500,
		slidesPerView: 4,
		spaceBetween: 30,
		autoplay: false,
	...
	var slider = new Swiper(".banner-home2-classic-active", {
		speed: 1500,
		slidesPerView: 4,
		spaceBetween: 30,
		loop: true,
	...
	var slider = new Swiper(".service-home2-classic-active", {
		speed: 1500,
		slidesPerView: 4,
		spaceBetween: 30,
		loop: true,
	...
	var slider = new Swiper(".testi-home2-classic-active", {
		speed: 1500,
		slidesPerView: 4,
		spaceBetween: 30,
		loop: true,
	...
	// testi-home2-active
	var slider = new Swiper(".testi-home3-active", {
		speed: 1500,
		slidesPerView: 4,
		spaceBetween: 30,
		autoplay: false,
	...
	var slider = new Swiper(".banner-home3-classic-active", {
		speed: 1500,
		slidesPerView: 4,
		spaceBetween: 30,
		loop: true,
	...
	var slider = new Swiper(".testi-home3-classic-active", {
		speed: 1500,
		slidesPerView: 4,
		spaceBetween: 30,
		loop: true,
...
window.addEventListener("load", () => {
	...
	$(function () {
		$(document).on('mouseenter', '.joint-event-box', function () {
