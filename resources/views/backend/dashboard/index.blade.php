 <x-app>
         ...
         <div class="col-lg-3 col-12">
             ...
             <div class="card p-4  bg-primary bg-opacity-10 border border-primary border-opacity-25 rounded-2">
                 ...
                 <div class="d-flex gap-3 ">
                     ...
                     <div>
                         <h2 class=" fs-6 mb-0">Total Blogs</h2>
                         <h3 class="fw-bold mb-0">{{ $blogs_count }}</h3>
             ...
             <div class="card p-4  bg-success bg-opacity-10 border border-success border-opacity-25 rounded-2">
                 ...
                 <div class="d-flex gap-3 ">
                     <div class="icon-shape icon-md bg-success text-white rounded-2">
                         <i class="ti ti-browser-share fs-4"></i>
                     </div>
                     <div>
                         <h2 class="fs-6 mb-0">Total Pages</h2>
                         <h3 class="fw-bold mb-0">{{ $pages_count }}</h3>
             ...
             <div class="card p-4  bg-info bg-opacity-10 border border-info border-opacity-25 rounded-2">
                 ...
                 <div class="d-flex gap-3 ">
                     <div class="icon-shape icon-md bg-info text-white rounded-2">
                         <i class="ti ti-bubble fs-4"></i>
                     </div>
                     <div>
                         <h2 class=" fs-6 mb-0">Total Comments</h2>
                         <h3 class="fw-bold mb-0">{{ $comments_count }}</h3>
         ...
         <div class="col-lg-3 col-12">
             ...
             <div class="card p-4  bg-warning bg-opacity-10 border border-warning border-opacity-25 rounded-2">
                 ...
                 <div class="d-flex gap-3 ">
                     ...
                     <div>
                         <h2 class=" fs-6 mb-0">Total Testimonials</h2>
                         <h3 class="fw-bold mb-0">{{ $testimonials_count }}</h3>
     ...
     <div class="row g-3 mb-3">
                 ...
                 <ul class="list-group list-group-flush">
                     @foreach ($latest_blogs as $blog)
                         <li class="list-group-item d-flex align-items-center gap-3">
                             <img src="{{ url(changeSize(imgUrl($blog->img), '150x150')) }}" class="rounded"
                                 width="48">
                             <div class="flex-grow-1">
                                 <p class="mb-1">{{ $blog->title }}</p>
                             </div>
                             <a href="{{ url('blog/' . $blog->slug) }}"
                                 class="badge bg-success-subtle text-success border border-success">View</a>
                         </li>
                     @endforeach
                 </ul>
             </div>
         ...
         <div class="col-lg-4">
             <div class="card  h-100">
                 <div class="card-header bg-white d-flex justify-content-between align-items-center px-4 py-3">
                     <h4 class="mb-0 h5">Comments</h4>
                     <a href="{{ route('seo.blogs.comments') }}">
                         <button class="btn btn-sm btn-outline-success">
                             View All <i class="ti ti-arrow-narrow-right"></i>
                         </button>
                     </a>
                 ...
                 <ul class="list-group list-group-flush">
                     @foreach ($latest_comments as $comment)
                         <li class="list-group-item d-flex align-items-start gap-3">
                             ...
                             @php
                                 $colors = ['#0d6efd', '#6610f2', '#198754', '#dc3545', '#fd7e14'];
                                 $color = $colors[crc32($comment->email) % count($colors)];
                             @endphp
