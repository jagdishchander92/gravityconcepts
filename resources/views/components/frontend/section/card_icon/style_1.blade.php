        ...
        <div class="container">
            <div class="row items text-left">
                @foreach ($items as $item)
                    <div data-aos="fade-up" class="col-12 col-md-6 col-lg-4 mb-3 item aos-init aos-animate">
                        <div class="card h-100 p-4">
                            <div class="col-12">
                                <i class="icon {{ $item['icon'] }}" style="margin:unset !important;color:var(--primary-t-color);"></i>
